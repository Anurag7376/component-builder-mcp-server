...
export async function testLambdaCompatibility() {
  ...
  console.log(
    `Generate Component Response: ${generateResponse.statusCode === 200 ? "✅" : "❌"}`
  );
  console.log(
    `Validate Component Response: ${validateResponse.statusCode === 200 ? "✅" : "❌"}`
  );
  ...
  console.log(
    `Response Structure Valid: ${hasRequiredFields(generateResponse) && hasRequiredFields(validateResponse) ? "✅" : "❌"}`
  );
